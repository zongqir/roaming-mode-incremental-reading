<div class="sy__outline" style="max-width: 800px; margin: 0 auto;">
    <div style="text-align: center; padding: 2em; background: linear-gradient(135deg, #6366f1, #8b5cf6); border-radius: 12px;">
        ...
        <div style="color: rgba(255,255,255,0.9); margin-top: 0.5em; font-size: 1.1em;">Intelligent recommendation algorithm-driven incremental reading plugin for stress-free "read later" learning experience</div>
        <div style="margin-top: 1.5em; display: flex; justify-content: center; gap: 12px; flex-wrap: wrap;">
            ...
            <a href="https://github.com/ebAobS/roaming-mode-incremental-reading/issues"
               style="padding: 8px 16px; background: rgba(255,255,255,0.2); color: white; border-radius: 6px; text-decoration: none; font-size: 0.9em;">💬 Issues</a>
    ...
    <div style="margin-top: 1.5em; padding: 1.5em; background: linear-gradient(135deg, #f0f9ff, #e0f2fe); border: 1px solid #bae6fd; border-radius: 8px; box-shadow: 0 4px 12px rgba(14,165,233,0.15);">
        ...
        <ul style="margin: 0; padding-left: 1.2em;">
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #6366f1; box-shadow: 0 2px 4px rgba(99,102,241,0.08);">🎯 <strong>Intelligent Priority Recommendation</strong> - Hybrid recommendation mechanism based on roulette wheel algorithm and absolute priority order</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #8b5cf6; box-shadow: 0 2px 4px rgba(139,92,246,0.08);">⚖️ <strong>Custom Metric Weights</strong> - Users can customize metrics like difficulty, importance, urgency, and their weights</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #06b6d4; box-shadow: 0 2px 4px rgba(6,182,212,0.08);">📊 <strong>Visual Priority</strong> - Strip chart clearly displays document priorities with direct drag adjustment</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b; box-shadow: 0 2px 4px rgba(245,158,11,0.08);">📁 <strong>Flexible Filtering</strong> - Support multi-select notebooks and root document filtering for precise learning scope</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #ef4444; box-shadow: 0 2px 4px rgba(239,68,68,0.08);">📝 <strong>Real-time Adjustment</strong> - Adjust article metrics in real-time during reading to dynamically optimize recommendation algorithm</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #8b5cf6; box-shadow: 0 2px 4px rgba(139,92,246,0.08);">📈 <strong>Roamed Document Management</strong> - Roamed document list + heatmap with batch priority adjustment and drag sorting</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #6366f1; box-shadow: 0 2px 4px rgba(99,102,241,0.08);">📋 <strong>Roaming History Tracking</strong> - Record reading history, roaming count and access time to track learning progress</li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #10b981; box-shadow: 0 2px 4px rgba(16,185,129,0.08);">🔄 <strong>Auto Reset</strong> - Support automatic reset of visited document records when starting SiYuan</li>
        </ul>
    </div>
    <div style="margin-top: 1.5em; padding: 1.5em; background: linear-gradient(135deg, #fef3f2, #fee2e2); border: 1px solid #fca5a5; border-radius: 8px; box-shadow: 0 4px 12px rgba(239,68,68,0.15);">
        ...
        <p style="margin: 0.5em 0;">If Roaming Mode Incremental Reading has helped your learning, please consider giving the author a like or buying them a coffee. This will encourage the author to continue optimizing and developing more practical features:</p>
...
<strong style="color: #6366f1; font-size: 1.1em;">📅 v2.1.0 Update (2025.7.22)</strong>
...
<li><strong>🎲 Random Mode</strong>: Support completely random "one-time" mode</li>
    ...
    <div style="margin-top: 1.5em; padding: 1.5em; background: linear-gradient(135deg, #fefbff, #f3e8ff); border: 1px solid #c4b5fd; border-radius: 8px; box-shadow: 0 4px 12px rgba(139,92,246,0.15);">
        ...
        <ul style="margin: 0; padding-left: 1.2em;">
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                1. Search for "Roaming Mode Incremental Reading" in SiYuan plugin marketplace<br>
                2. Click install button to complete plugin installation<br>
                3. After installation, plugin icon will appear in the top bar
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. Right-click on top bar plugin icon to enter settings page<br>
                2. Customize metrics you need (such as difficulty, importance, urgency, etc.)<br>
                3. Set weight percentages for each metric<br>
                4. Select notebooks or root documents to include<br>
                5. Set absolute priority order roaming parameter (between 0-1)<br>
                6. Choose whether to automatically reset visited document records when starting SiYuan<br>
                7. Click save after setup
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. Click top bar plugin icon to start incremental reading<br>
                2. System will recommend articles based on set metrics and weights<br>
                3. Read recommended articles for learning<br>
                4. Click "Edit" button to open article in new tab for excerpting, card-making, etc.
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. During reading, adjust article metrics based on actual situation<br>
                2. Use plus/minus buttons to adjust metric values<br>
                3. Metric adjustments will affect article priority calculation in real-time<br>
                4. This is more precise than traditional "forgot"/"remember" buttons
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. When you feel tired of current article, encounter difficulties, or want variety<br>
                2. Click "Continue Roaming" button<br>
                3. System will intelligently recommend next article<br>
                4. Achieve stress-free "read later" experience
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. View roaming history in settings page<br>
                2. Understand read articles, roaming count and last access time<br>
                3. Batch manage document priorities through roamed document list + heatmap<br>
                4. Track learning progress and effectiveness to help optimize learning strategies
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                <details>
                <summary style="color: #0369a1; cursor: pointer; font-weight: 500; font-size: 1.05em;">📊 <strong>Visual Priority Management</strong> - Strip Chart</summary>
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. Clearly view priority distribution of all documents through strip chart<br>
                2. Directly drag to adjust document priorities with proportional changes to related metrics<br>
                3. Batch adjust priorities in roamed document list<br>
                4. Support drag sorting with automatic priority calculation as average of adjacent documents
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                <details>
                <summary style="color: #0369a1; cursor: pointer; font-weight: 500; font-size: 1.05em;">🎲 <strong>Hybrid Recommendation Mechanism</strong> - Intelligent Balance</summary>
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. Set absolute priority order roaming parameter (between 0-1)<br>
                2. Set to 1: Absolutely roam documents in priority order<br>
                3. Set to 0: Completely roam using roulette wheel method with priority as weight probability<br>
                4. Set to decimal: Probability of roaming in absolute priority order, otherwise roulette wheel<br>
                5. Flexibly adjust recommendation strategy based on learning needs
                </div>
                </details>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #0369a1; box-shadow: 0 2px 4px rgba(124,58,237,0.08);">
                ...
                <div style="margin-top: 0.8em; padding-top: 0.8em; border-top: 1px solid #f3e8ff;">
                1. Support multi-select notebooks for filtering with free combination<br>
                2. Support root document selection for filtering<br>
                3. Precise targeting of learning scope to improve reading efficiency<br>
                4. Flexible configuration of learning content to meet different learning needs
                </div>
                </details>
            </li>
        </ul>
    ...
    <div style="margin-top: 1.5em; padding: 1.5em; background: linear-gradient(135deg, #fef7ff, #fdf2f8); border: 1px solid #f9a8d4; border-radius: 8px; box-shadow: 0 4px 12px rgba(236,72,153,0.15);">
        ...
        <div style="background: white; padding: 1.5em; border-radius: 8px; border-left: 4px solid #ec4899;">
            ...
            <ul style="margin: 0.5em 0; padding-left: 1.2em;">
                <li style="margin: 0.3em 0;"><strong>Flashcards</strong> review algorithm principle is <strong>forgetting curve</strong>, for which SiYuan flashcard system + FSRS algorithm is already sufficiently perfect. Years of experience using Anki and SuperMemo tell us that the "minimum information principle" for cards is extremely important.</li>
                <li style="margin: 0.3em 0;"><strong>Incremental reading</strong> deals with large text segments, inherently not conforming to the "minimum information principle". Most current incremental reading solutions habitually use forgetting curve-based review algorithms (like FSRS) to recommend article reviews, which is not reasonable.</li>
            </ul>
            <p style="margin: 0.5em 0; line-height: 1.6;">For a lengthy article, it's difficult to <strong>solely use memory level</strong> as the standard for whether to <strong>be recommended for review next time</strong>. The real <strong>standard should be multi-dimensional</strong>, such as difficulty, learning progress, importance of learning content, urgency, interest level, etc.</p>
            <p style="margin: 0.5em 0; line-height: 1.6;"><strong>In summary, the core purpose of incremental reading is not to "fight forgetting", but to achieve stress-free "read later", ultimately efficiently learning large amounts of material simultaneously.</strong></p>
        </div>
    </div>
    <div style="margin-top: 1.5em; padding: 1.5em; background: linear-gradient(135deg, #fffbeb, #fef3c7); border: 1px solid #fbbf24; border-radius: 8px; box-shadow: 0 4px 12px rgba(245,158,11,0.15);">
        ...
        <ul style="margin: 0; padding-left: 1.2em;">
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b; box-shadow: 0 2px 4px rgba(245,158,11,0.08);">
                <strong>Based on Project</strong>：<a href="https://github.com/terwer/siyuan-plugin-random-doc.git" style="color: #d97706;">SiYuan Plugin: Document Roaming</a>（Author：<a href="https://github.com/terwer" style="color: #d97706;">terwer</a>）
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b; box-shadow: 0 2px 4px rgba(245,158,11,0.08);">
                <strong>Project Repository</strong>：<a href="https://github.com/ebAobS/roaming-mode-incremental-reading" style="color: #d97706;">GitHub Repository</a>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b; box-shadow: 0 2px 4px rgba(245,158,11,0.08);">
                <strong>Discussion Thread</strong>：<a href="https://ld246.com/article/1746802777105" style="color: #d97706;">Roaming Mode Incremental Reading | The Only Usable Incremental Reading Recommendation Solution</a>
            </li>
            <li style="margin: 0.5em 0; padding: 10px 14px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b; box-shadow: 0 2px 4px rgba(245,158,11,0.08);">
